<main id="main" class="main">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="<?php echo site_url('request/makerequest'); ?>" class="row g-3 needs-validation" novalidate>

                <div class="col-md-12 position-relative">
                    <label for="validationTooltip01" class="form-label">Title</label>
                    <input type="text" name="title" class="form-control" id="validationTooltip01" value="John" required />
