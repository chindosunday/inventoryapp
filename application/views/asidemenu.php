<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo site_url('requestpage/viewrequests'); ?>">
                <i class=" bi bi-person"></i>
                <span>Requests</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            ...
            <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="<?php echo site_url('createstock'); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo site_url('viewallstaff'); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo site_url('alldistributors'); ?>">
                <i class="bi bi-envelope"></i>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo site_url("signup"); ?>">
